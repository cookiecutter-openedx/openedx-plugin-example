...
from .views.course_audit import plugin_cms_course_audit, plugin_cms_course_audit_csv, plugin_cms_course_audit_refresh
from .views.course_audit_html import plugin_cms_course_audit_html, plugin_cms_course_audit_html_csv

urlpatterns = [
    # Log paginated UI
    url(r"^log/$", plugin_cms_change_log, name="plugin_cms_change_log"),
    url(rf"^courses/{settings.COURSE_ID_PATTERN}/log/$", plugin_cms_change_log, name="plugin_cms_change_log"),
    url(
    ...
    url(rf"^courses/{settings.COURSE_ID_PATTERN}/log/csv/$", plugin_cms_change_csv, name="plugin_cms_change_csv"),
    url(
    ...
    url(rf"^courses/{settings.COURSE_ID_PATTERN}/audit/$", plugin_cms_course_audit, name="plugin_cms_course_audit"),
    url(
